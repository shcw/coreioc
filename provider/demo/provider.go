...
func (sp *DemoServiceProvider) Register(c core.Container) core.NewInstance {
...
func (sp *DemoServiceProvider) Params(c core.Container) []interface{} {
	return []interface{}{c}
}

// Boot方法我们这里我们什么逻辑都不执行, 只打印一行日志信息
func (sp *DemoServiceProvider) Boot(c core.Container) error {
